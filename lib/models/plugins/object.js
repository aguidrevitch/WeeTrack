...
module.exports = function (schema, options) {
    ...
    schema.methods.flatten = function () {
        ...
        _.each(options.permissions, function (multiple, perm) {
            if (multiple) {
                ...
                perms[perm] = this[perm] && 'object' == typeof this[perm] ? this[perm]._id.toString() : this[perm];
                //perms[perm] = 'object' == typeof this[perm] ? this[perm]._id.toString() : this[perm];
            }
        }, this);
        _.extend(this, perms);
    };
    ...
    schema.statics.findWithAccess = function (user, perms, conditions, fields, options, callback) {
        ...
        this.find.apply(this, [criteria, fields, options, callback]);
    };
    ...
    schema.statics.findOneWithAccess = function (user, perms, conditions, fields, options, callback) {
        ...
        this.findOne.apply(this, [criteria, fields, options, callback]);
    };
