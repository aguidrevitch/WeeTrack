            ...
            _.each(this.administrators, function (user_id) {
                if (user_id)
                    grants.push(_.bind(function (callback) {
                        ...
                        Subject.grant(user_id, this.path, ['admin'], callback);
                    }, this));
            }, this);
            _.each(this.users, function (user_id) {
                if (user_id)
                    grants.push(_.bind(function (callback) {
                        ...
                        Subject.grant(user_id, this.path, ['admincc'], callback);
                    }, this));
            }, this);
            ...
            _.each(this.clients, function (user_id) {
                if (user_id)
                    grants.push(_.bind(function (callback) {
                        ...
                        Subject.grant(user_id, this.path, ['cc'], callback);
                    }, this));
            }, this);
            ...
            _.each(_.difference(result.administrators, this.administrators), function (user_id) {
                if (user_id)
                    revokes.push(_.bind(function (callback) {
                        ...
                        Subject.revoke(user_id, this.path, ['admin'], callback);
                    }, this));
            }, this)
            ...
            _.each(_.difference(result.users, this.users), function (user_id) {
                if (user_id)
                    revokes.push(_.bind(function (callback) {
                        ...
                        Subject.revoke(user_id, this.path, ['admincc'], callback);
                    }, this));
            }, this)

            _.each(_.difference(result.clients, this.clients), function (user_id) {
                if (user_id)
                    revokes.push(_.bind(function (callback) {
                        // console.log("revoking cc " + user_id);
                        Subject.revoke(user_id, this.path, ['cc'], callback);
                    }, this));
            }, this)
