define(["backbone", "modules/transaction"], function (Backbone, Transaction) {
    ...
    var PermissionModel = Backbone.Model.extend({
        getAccess: function (user) {
            return {
                admin: _.filter(this.get('administrators'), function (o) {
                    return user.id == o._id;
                }),
                admincc: _.filter(this.get('users'), function (o) {
                    return user.id == o._id;
                }),
                cc: _.filter(this.get('clients'), function (o) {
                    return user.id == o._id;
                }),
                watch: _.filter(this.get('watchers'), function (o) {
                    return user.id == o._id;
                })
            };
        },
